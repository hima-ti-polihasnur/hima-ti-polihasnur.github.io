...
const template = (id, img, vid, nama, jabatan, nim, ttl, angkatan, namaPanggilan, quote, hobi) => {
  ...
  <div class="card m-3 shadow" style="width: 18rem;">
      <img src="${img}" style="width: 100%; class="card-img-top" alt="...">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <div class="ratio ratio-1x1">
                                      <video class="shadow rounded-md" width="200" height="300" poster="https://hima-ti-poilhasnur.github.io/assets/img/preloader.jpg" autoplay loop muted>
